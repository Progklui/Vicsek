...
# assign directory
directory = '..\\simulation_results\\N_1000_L_1.000000_v_0.030000_R_1.000000_D_0.100000\\Neq_2000_Nsim_100000_dt_1.000000\\'
...
animator = ani.FuncAnimation(fig, update, frames=range(len(xData)), interval=500)
plt.show()
plt.close()
