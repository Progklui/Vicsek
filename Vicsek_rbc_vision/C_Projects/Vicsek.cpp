...
Vicsek::Vicsek(double L_init, int N_init, double D_rot_init, double v_init, double R_init, double dt_init, int Nsim_init, int Nsave_init, char * dir_name_init, int init, double phi_vision_init) {
